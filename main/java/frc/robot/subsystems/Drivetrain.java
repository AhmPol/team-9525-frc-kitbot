...
*/
 public class Drivetrain extends SubsystemBase {
  private final CANSparkMax leftFront = new CANSparkMax(DrivetrainConstants.kLeftFrontID, MotorType.kBrushed);;
  private final CANSparkMax leftRear = new CANSparkMax(DrivetrainConstants.kLeftRearID, MotorType.kBrushed);
  private final CANSparkMax rightFront = new CANSparkMax(DrivetrainConstants.kRightFrontID, MotorType.kBrushed);
  private final CANSparkMax rightRear = new CANSparkMax(DrivetrainConstants.kRightRearID, MotorType.kBrushed);
  ...
  /*Constructor. This method is called when an instance of the class is created. This should generally be used to set up
    ...
    */
  public Drivetrain() {
    SendableRegistry.addChild(drivetrain, leftFront);
    SendableRegistry.addChild(drivetrain, rightFront);
    SendableRegistry.addChild(drivetrain, leftRear);
    SendableRegistry.addChild(drivetrain, rightRear);
