...
//public final class Autos {
  ...
  /* public static Command RedRightAuto(Drivetrain drivetrain, Launcher launcher) {
    return Commands.sequence(
        ...
        new RunCommand(() -> drivetrain.arcadeDrive(0.0, -0.5), drivetrain) // Turn left
            .withTimeout(1.25), // Adjust time based on testing
  ...
  */
  ...
  /* public static Command BlueLeftAuto(Drivetrain drivetrain, Launcher launcher) {
    return Commands.sequence(
        new PrepareLaunch(launcher)
            .withTimeout(LauncherConstants.kLauncherDelay)
            .andThen(new Launch(launcher))
