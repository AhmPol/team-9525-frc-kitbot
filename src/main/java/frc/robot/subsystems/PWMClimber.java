...
public class PWMClimber extends SubsystemBase {
  ...
  public PWMClimber() {
    m_climbMotor = new PWMSparkMax(ClimberConstants.kclimberID);
  ...
  public Command ascend() {
    ...
    return this.startEnd(
        () -> {
          ...
          while (!topSwitch.get()) {
            setClimbSpeed(ClimberConstants.kclimberAscendSpeed);
          }
          stop();
        },
        () -> {
    ...
    return this.startEnd(
        () -> {
          while (bottomSwitch.get()) {
            setClimbSpeed(ClimberConstants.kclimberDescendSpeed);
          }
          stop();
        },
        () -> {
