...
public final class Autos {
  ...
  public static Command shootAndSitAuto(Launcher launcher) {
  ...
  public static Command shootAndDriveDiagonalBackwardAuto(Drivetrain drivetrain, Launcher launcher) {
    ...
    public static Command shootAndDriveStraightBackwardAuto(Drivetrain drivetrain, Launcher launcher) {
